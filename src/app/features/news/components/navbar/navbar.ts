...
@Component({
  selector: 'app-navbar',
  imports: [CommonModule, FormsModule, NewsModal, Spinner, LucideIconsModule],
...
export class Navbar {
  ...
  isSearchVisible = false; // Controla la visibilidad del campo de búsqueda movible
    ...
    router.events
      ...
      .subscribe((e: NavigationEnd) => {
        ...
        if (!this.isDetailPage) {
          ...
          if (this.activeId) {
            this.newsService
              .getNewsById(Number(this.activeId))
              .subscribe((article) => {
